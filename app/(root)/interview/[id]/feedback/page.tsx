  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
        ...
        <Link
          href={`/interview/${id}/ai-coach`}
          className="flex items-center justify-center gap-2 px-6 py-3 rounded-full font-medium text-white shadow-lg transition-all duration-300 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 hover:shadow-teal-900/30 flex-1 max-w-64"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
